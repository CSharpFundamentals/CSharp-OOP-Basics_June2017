...
{
    public class DriftRace : NormalRace
    {
        ...
        public override void Start()
        {
            ...
            Dictionary<int, Car> orderedParticipants = this.Participants
                .OrderByDescending(n => n.Value.SuspensionPerformance)
        ...
        protected override string GetWinningStats()
        {
            ...
            foreach (var winner in Winners)
            {
                ...
                result.AppendLine(string.Format(
                    $"{count}. {winner.Brand} {winner.Model} {winner.SuspensionPerformance}PP - ${prize}"));
                count++;
            }
